...
- `TESLA_STATUS_INTERVAL_SEC`, `TESLA_IDLE_STATUS_INTERVAL_SEC` et `TESLA_DETAIL_INTERVAL_SEC` si tu veux ajuster la fréquence des lectures Tesla et garder le coût sous contrôle
